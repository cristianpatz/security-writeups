...
With Burp Suite open, forwarded "My Account" request to Repeater and replaced my ID with Carlos': `/my-account?id=bb62e9f3-5f41-47e9-aa90-e875dbeeec41`. Response loaded Carlos' account without authentication, revealing username carlos and API Key `pAiYivfjAbsqidSuekCmHhafYRtKIVaT`.
